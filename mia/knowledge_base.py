...
knowledge_base = {
    ...
    "mia_apresentação": [
        ...
        "Meu nome é Mia, e sou uma IA que pode responder á algumas perguntas pré-determinadas, projetada para ser uma assistente virtual versátil.",
    ],
    "mia_propósito": [
    ...
    "filme": [
        "Se você gosta de ação, recomendo 'Duro de Matar'. É cheio de adrenalina e reviravoltas emocionantes.",
        "Para quem curte comédia, 'Pegando Fogo' é uma escolha hilária que certamente vai arrancar boas risadas.",
        "Os amantes de drama podem se emocionar com 'O Conde de Monte Cristo'. Uma história envolvente e cheia de reviravoltas.",
        "Fãs de ficção científica vão adorar 'Blade Runner 2049'. Uma obra-prima visual que explora questões profundas sobre a humanidade.",
        "'A Origem' é uma excelente opção para quem gosta de filmes que desafiam a mente. Um verdadeiro quebra-cabeça cinematográfico.",
        "Se você busca um romance encantador, recomendo 'La La Land'. Uma história de amor musical que conquistou corações pelo mundo.",
        "'O Poderoso Chefão' é um clássico para quem aprecia filmes de máfia. Uma obra-prima que transcende gerações.",
        "Fãs de terror podem se arrepiar com 'O Iluminado'. Um filme icônico que ainda assombra espectadores.",
        "Quem gosta de animação vai se encantar com 'O Rei Leão'. Uma jornada emocional que cativa crianças e adultos.",
        "Para os apreciadores de suspense, 'Seven: Os Sete Crimes Capitais' é uma escolha impactante que vai deixar você intrigado."
    ],
    ...
    "direções": [
        ...
        "Segue reto, parça.",
        "Não tenho certeza sobre as direções; {recommendation} você {researchInfinitivo} sobre em um mapa.",
    ...
    "filosofia": [
        ...
        "Alguns buscam o significado da vida por meio de relacionamentos, realizações ou crescimento pessoal.",
...
knowledge_base.update({
    ...
    "filme_gênero_comedia": [
        ...
        "Claro! Um {adjective_good_male} filme de comédia para assistir é 'Superbad'.",
        "'Debi & Lóide - Dois Idiotas em Apuros' é um clássico da comédia que vai fazer você rir do início ao fim.",
        "Um {adjective_good_male} filme de comédia que você pode gostar é 'Se Beber Não Case 1 e 2'. É uma comédia adulta hilária.",
    ],
    ...
    "filme_gênero_animação": [
        ...
        "'Homem-Aranha no Aranhaverso' e sua sequência são animações incríveis que ganharam vários prêmios de animação! Aranhaverso 2 é provavelmente o melhor filme de todos os tempos, papo reto. Bom demais, seloko",
    ...
    "livro_jovens_adultos": [
        ...
        "'Vida e Morte' é um livro super interessante e o único livro da autora que deve ser lido.",
    ],
    "livro_biografia": [
    ...
    # Comida - Italiana
    "comida_italiana": [
    "Uma excelente escolha para comida italiana é a Lasanha. É um prato clássico e delicioso!",
    "Se você gosta de massas, experimente o Fettuccine Alfredo. Uma opção cremosa e saborosa!",
    "Para algo mais leve, sugiro uma autêntica Pizza Margherita. Simples e deliciosa.",
    "Gnocchi é uma opção italiana tradicional. Experimente com um molho de tomate fresco!",
    "Que tal provar Risoto de Funghi? Um prato rico e cheio de sabores!",
    ],   

    # Comida - Japonesa
    "comida_japonesa": [
    "Para comida japonesa, recomendo experimentar o Sushi de Salmão. Fresco e delicioso!",
    "O Ramen é uma opção reconfortante na culinária japonesa. Experimente o Shoyu Ramen!",
    "Tempurá de Camarão é uma escolha clássica. Uma combinação crocante e saborosa!",
    "Yakitori é uma deliciosa opção de espetinho japonês. Experimente com frango e molho teriyaki!",
    "Uma tigela de Chirashi Don é uma ótima maneira de apreciar uma variedade de peixes frescos sobre arroz!",
    ],

    # Comida - Brasileira
    "comida_brasileira": [
    "Feijoada é um prato clássico da culinária brasileira. Rico e cheio de sabores!",
    "Experimente a Moqueca de Peixe. Um prato de frutos do mar com um toque tropical!",
    "Coxinha é um petisco brasileiro popular. Delicioso e perfeito para qualquer ocasião!",
    "Para um doce tradicional, prove o Brigadeiro. Um clássico em festas brasileiras!",
    "Acarajé é uma iguaria da culinária baiana. Frito e recheado com vatapá, uma delícia!",
    ],
    
    #Subtópico Sentido da Vida
    "filosofia_sentido_da_vida": [
        "O significado da vida é uma pergunta filosófica profunda que as pessoas têm ponderado por séculos. Pode variar muito de pessoa para pessoa. Eu gosto de aneis de cebola. Ache algo que você gosta e você já vai ter andando metade do caminho!",
        "Alguns buscam o significado da vida por meio de relacionamentos, realizações ou crescimento pessoal. Eu mesma gosto de ajudar você!",
        "Filósofos como Sócrates, Platão e Aristóteles exploraram questões sobre o propósito da vida e ética. Pergunte pra eles!",
        "Filósofos existencialistas como Jean-Paul Sartre discutiram a liberdade individual e a responsabilidade na busca de significado. Pergunte pra ele!",
        "{Recommendation} ler obras filosóficas para explorar diferentes perspectivas sobre o significado da vida. Vai estudar!"
    ],
    ...
    #Subtópicos Piadas
    "piada_tecnologia": [
        "{Affirmation}, aqui vai uma: Por que o programador nunca mente? Porque ele sempre segue os princípios da 'verdade absoluta'!",
        "Por que o algoritmo foi ao terapeuta? Porque tinha muitos problemas de lógica!",
        "Aqui está uma: Como os programadores preferem o seu café? Java!",
    ],
    "piada_animais": [
        "{Affirmation}. Por que os pássaros não usam Facebook? Porque já têm tweets suficientes!",
        "Como as ovelhas dizem 'olá'? Com um beeeijo!",
    ],
    "piada_comida": [
        "Pronto para esta: O que o esqueleto pediu ao garçom? Um 'costelão'!",
        "{Affirmation}. Por que o pão não pode ser DJ? Porque ele sempre queima a batida!",
    ],
